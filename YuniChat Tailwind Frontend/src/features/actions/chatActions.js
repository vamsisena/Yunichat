...
export const updateMessageStatus = (payload) => ({
  ...
  payload, // payload should contain: { messageId, isRead, readAt }
});
...
// Clear public messages when TTL expires
export const clearPublicMessagesAction = () => ({
  type: 'CLEAR_PUBLIC_MESSAGES',
});
